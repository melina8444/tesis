...
urlpatterns = [
    ...
    path('clientes/', ProfileListView.as_view(), name='listar_clientes'),
    path('clientes/create/', ProfileCreateView.as_view(), name='crear_clientes'),
    path('clientes/update/<int:pk>/', ProfileUpdateView.as_view(), name='modificar_cliente'),
    path('clientes/delete/<int:pk>/', ProfileDeleteView.as_view(), name='eliminar_cliente'),
